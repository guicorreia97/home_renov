# Delta: Frontend — Localisation

**Change ID:** `add-i18n-pt-en`
**Affects:** `frontend/src/i18n/`, `frontend/src/lib/format.ts`,
`frontend/src/features/expenses/`, `frontend/src/App.tsx`, `frontend/index.html`
